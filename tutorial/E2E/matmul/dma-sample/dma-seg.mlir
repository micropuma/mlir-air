module {
  func.func @graph(%arg0: memref<256xi32>, %arg1: memref<256xi32>) {
    ...
    air.launch (%arg2, %arg3) in (%arg4=%c1, %arg5=%c1) args(%arg6=%arg0, %arg7=%arg1) : memref<256xi32>, memref<256xi32> {
      air.segment @graph_0  args(%arg8=%arg6, %arg9=%arg7) : memref<256xi32>, memref<256xi32> {
        %c1_0 = arith.constant 1 : index
        air.herd @copyherd  tile (%arg10, %arg11) in (%arg12=%c1_0, %arg13=%c1_0) args(%arg14=%arg8, %arg15=%arg9) : memref<256xi32>, memref<256xi32> {
