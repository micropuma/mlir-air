...
module {
  ...
  func.func @matmul_bf16(%arg0: memref<512x1024xbf16>, %arg1: memref<1024x512xbf16>, %arg2: memref<512x512xbf16>) {
    ...
    %0 = air.launch async (%arg3, %arg4) in (%arg5=%c2, %arg6=%c2) args(%arg7=%arg2, %arg8=%arg0, %arg9=%arg1) : memref<512x512xbf16>, memref<512x1024xbf16>, memref<1024x512xbf16> attributes {id = 1 : i32} {
      ...
      %5 = air.channel.put async  @channel_12[%c0, %c0] (%arg8[%c0, %1, %c0] [%c4, %c64, %c256] [%c256, %c1024, %c1]) {id = 1 : i32} : (memref<512x1024xbf16>)
      %6 = air.channel.put async  @channel_12[%c1, %c0] (%arg8[%c0, %2, %c0] [%c4, %c64, %c256] [%c256, %c1024, %c1]) {id = 2 : i32} : (memref<512x1024xbf16>)
      %7 = air.channel.put async  @channel_12[%c2_0, %c0] (%arg8[%c0, %3, %c0] [%c4, %c64, %c256] [%c256, %c1024, %c1]) {id = 3 : i32} : (memref<512x1024xbf16>)
      %8 = air.channel.put async  @channel_12[%c3, %c0] (%arg8[%c0, %4, %c0] [%c4, %c64, %c256] [%c256, %c1024, %c1]) {id = 4 : i32} : (memref<512x1024xbf16>)
      %9 = affine.apply #map()[%arg4]
      %10 = affine.apply #map1()[%arg4]
      %11 = affine.apply #map2()[%arg4]
      %12 = affine.apply #map3()[%arg4]
      %13 = air.channel.put async  @channel_13[%c0, %c0] (%arg9[%c0, %9] [%c1024, %c64] [%c512, %c1]) {id = 5 : i32} : (memref<1024x512xbf16>)
      %14 = air.channel.put async  @channel_13[%c1, %c0] (%arg9[%c0, %10] [%c1024, %c64] [%c512, %c1]) {id = 6 : i32} : (memref<1024x512xbf16>)
      %15 = air.channel.put async  @channel_13[%c2_0, %c0] (%arg9[%c0, %11] [%c1024, %c64] [%c512, %c1]) {id = 7 : i32} : (memref<1024x512xbf16>)
      %16 = air.channel.put async  @channel_13[%c3, %c0] (%arg9[%c0, %12] [%c1024, %c64] [%c512, %c1]) {id = 8 : i32} : (memref<1024x512xbf16>)
