module {
  aie.device(npu1_4col) {
    ...
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[32768, 0, 0, 134217728, -2080374273, 127, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[32768, 0, 0, 33554432, -1610612481, 131071, 1048703, 33554432]>
    memref.global "private" constant @blockwrite_data_2 : memref<8xi32> = dense<[16384, 0, 0, 134217728, -2080374529, 127, 1114111, 33554432]>
    aiex.runtime_sequence @matmul_bf16(%arg0: memref<262144xi32>, %arg1: memref<262144xi32>, %arg2: memref<131072xi32>) {
      ...
      aiex.npu.blockwrite(%0) {address = 100782080 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 100782084 : ui32, arg_idx = 0 : i32, arg_plus = 0 : i32}
      aiex.npu.write32 {address = 119316 : ui32, column = 3 : i32, row = 0 : i32, value = 65536 : ui32}
      %1 = memref.get_global @blockwrite_data_0 : memref<8xi32>
      aiex.npu.blockwrite(%1) {address = 100782112 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 100782116 : ui32, arg_idx = 0 : i32, arg_plus = 524288 : i32}
      aiex.npu.write32 {address = 119316 : ui32, column = 3 : i32, row = 0 : i32, value = 65537 : ui32}
      %2 = memref.get_global @blockwrite_data_0 : memref<8xi32>
      aiex.npu.blockwrite(%2) {address = 67227648 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 67227652 : ui32, arg_idx = 0 : i32, arg_plus = 131072 : i32}
      aiex.npu.write32 {address = 119316 : ui32, column = 2 : i32, row = 0 : i32, value = 65536 : ui32}
      %3 = memref.get_global @blockwrite_data_0 : memref<8xi32>
      aiex.npu.blockwrite(%3) {address = 67227680 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 67227684 : ui32, arg_idx = 0 : i32, arg_plus = 655360 : i32}
      aiex.npu.write32 {address = 119316 : ui32, column = 2 : i32, row = 0 : i32, value = 65537 : ui32}
      %4 = memref.get_global @blockwrite_data_0 : memref<8xi32>
      aiex.npu.blockwrite(%4) {address = 33673216 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 33673220 : ui32, arg_idx = 0 : i32, arg_plus = 262144 : i32}
      aiex.npu.write32 {address = 119316 : ui32, column = 1 : i32, row = 0 : i32, value = 65536 : ui32}
      %5 = memref.get_global @blockwrite_data_0 : memref<8xi32>
      aiex.npu.blockwrite(%5) {address = 33673248 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 33673252 : ui32, arg_idx = 0 : i32, arg_plus = 786432 : i32}
      aiex.npu.write32 {address = 119316 : ui32, column = 1 : i32, row = 0 : i32, value = 65537 : ui32}
      %6 = memref.get_global @blockwrite_data_0 : memref<8xi32>
      aiex.npu.blockwrite(%6) {address = 118784 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 118788 : ui32, arg_idx = 0 : i32, arg_plus = 393216 : i32}
      aiex.npu.write32 {address = 119316 : ui32, column = 0 : i32, row = 0 : i32, value = 65536 : ui32}
      %7 = memref.get_global @blockwrite_data_0 : memref<8xi32>
      aiex.npu.blockwrite(%7) {address = 118816 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 118820 : ui32, arg_idx = 0 : i32, arg_plus = 917504 : i32}
      aiex.npu.write32 {address = 119316 : ui32, column = 0 : i32, row = 0 : i32, value = 65537 : ui32}
      %8 = memref.get_global @blockwrite_data_1 : memref<8xi32>
      aiex.npu.blockwrite(%8) {address = 100782144 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 100782148 : ui32, arg_idx = 1 : i32, arg_plus = 0 : i32}
      aiex.npu.write32 {address = 119324 : ui32, column = 3 : i32, row = 0 : i32, value = 65538 : ui32}
      %9 = memref.get_global @blockwrite_data_1 : memref<8xi32>
      aiex.npu.blockwrite(%9) {address = 100782176 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 100782180 : ui32, arg_idx = 1 : i32, arg_plus = 0 : i32}
      aiex.npu.write32 {address = 119324 : ui32, column = 3 : i32, row = 0 : i32, value = 65539 : ui32}
      %10 = memref.get_global @blockwrite_data_1 : memref<8xi32>
      aiex.npu.blockwrite(%10) {address = 67227712 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 67227716 : ui32, arg_idx = 1 : i32, arg_plus = 128 : i32}
      aiex.npu.write32 {address = 119324 : ui32, column = 2 : i32, row = 0 : i32, value = 65538 : ui32}
      %11 = memref.get_global @blockwrite_data_1 : memref<8xi32>
      aiex.npu.blockwrite(%11) {address = 67227744 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 67227748 : ui32, arg_idx = 1 : i32, arg_plus = 128 : i32}
      aiex.npu.write32 {address = 119324 : ui32, column = 2 : i32, row = 0 : i32, value = 65539 : ui32}
      %12 = memref.get_global @blockwrite_data_1 : memref<8xi32>
      aiex.npu.blockwrite(%12) {address = 33673280 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 33673284 : ui32, arg_idx = 1 : i32, arg_plus = 256 : i32}
      aiex.npu.write32 {address = 119324 : ui32, column = 1 : i32, row = 0 : i32, value = 65538 : ui32}
      %13 = memref.get_global @blockwrite_data_1 : memref<8xi32>
      aiex.npu.blockwrite(%13) {address = 33673312 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 33673316 : ui32, arg_idx = 1 : i32, arg_plus = 256 : i32}
      aiex.npu.write32 {address = 119324 : ui32, column = 1 : i32, row = 0 : i32, value = 65539 : ui32}
      %14 = memref.get_global @blockwrite_data_1 : memref<8xi32>
      aiex.npu.blockwrite(%14) {address = 118848 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 118852 : ui32, arg_idx = 1 : i32, arg_plus = 384 : i32}
      aiex.npu.write32 {address = 119324 : ui32, column = 0 : i32, row = 0 : i32, value = 65538 : ui32}
      %15 = memref.get_global @blockwrite_data_1 : memref<8xi32>
      aiex.npu.blockwrite(%15) {address = 118880 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 118884 : ui32, arg_idx = 1 : i32, arg_plus = 384 : i32}
      aiex.npu.write32 {address = 119324 : ui32, column = 0 : i32, row = 0 : i32, value = 65539 : ui32}
      %16 = memref.get_global @blockwrite_data_2 : memref<8xi32>
      aiex.npu.blockwrite(%16) {address = 118912 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 118916 : ui32, arg_idx = 2 : i32, arg_plus = 0 : i32}
      aiex.npu.maskwrite32 {address = 119296 : ui32, column = 0 : i32, mask = 3840 : ui32, row = 0 : i32, value = 3840 : ui32}
      aiex.npu.write32 {address = 119300 : ui32, column = 0 : i32, row = 0 : i32, value = 2147549188 : ui32}
      %17 = memref.get_global @blockwrite_data_2 : memref<8xi32>
      aiex.npu.blockwrite(%17) {address = 33673344 : ui32} : memref<8xi32>
      ...
      aiex.npu.write32 {address = 119300 : ui32, column = 1 : i32, row = 0 : i32, value = 2147549188 : ui32}
      %18 = memref.get_global @blockwrite_data_2 : memref<8xi32>
      aiex.npu.blockwrite(%18) {address = 67227776 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 67227780 : ui32, arg_idx = 2 : i32, arg_plus = 131072 : i32}
      aiex.npu.maskwrite32 {address = 119296 : ui32, column = 2 : i32, mask = 3840 : ui32, row = 0 : i32, value = 3840 : ui32}
      aiex.npu.write32 {address = 119300 : ui32, column = 2 : i32, row = 0 : i32, value = 2147549188 : ui32}
      %19 = memref.get_global @blockwrite_data_2 : memref<8xi32>
      aiex.npu.blockwrite(%19) {address = 100782208 : ui32} : memref<8xi32>
      aiex.npu.address_patch {addr = 100782212 : ui32, arg_idx = 2 : i32, arg_plus = 196608 : i32}
      aiex.npu.maskwrite32 {address = 119296 : ui32, column = 3 : i32, mask = 3840 : ui32, row = 0 : i32, value = 3840 : ui32}
      aiex.npu.write32 {address = 119300 : ui32, column = 3 : i32, row = 0 : i32, value = 2147549188 : ui32}
